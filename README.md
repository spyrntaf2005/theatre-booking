...
- **Διαχείριση Κρατήσεων**: Προβολή ιστορικού κρατήσεων στο Προφίλ του χρήστη.
- **Ακύρωση & Διαγραφή**: Ακύρωση μελλοντικών κρατήσεων και swipe-to-delete οριστική διαγραφή για τις ακυρωμένες.
